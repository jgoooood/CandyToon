...
<html lang="ko">
    ...
    <body>
        ...
        <div id="confirm">
            ...
            <form action="/member/changePw.jsp">
                <div id="inputInfo">
                    <div id="userId">
                        <input type="text" id="user-id" placeholder="아이디"><img src="../resources/images/icons/login.png" alt="로그인">
                    </div>
                    <div id="email">
                        <input type="email" id="user-email" placeholder="가입시 등록한 이메일"><img src="../resources/images/icons/email.png" alt="이메일">
                    </div>
                    <div>
                ...
                <div id="findBtn">
                    <button onclick="clickBtn()">인증확인</button></a>
                </div>
            </form>
        </div>
    </body>
